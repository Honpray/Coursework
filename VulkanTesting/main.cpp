...
//  Created by Hanbing Leng on 7/20/18.
...
private:
    ...
    void createInstance(){
        ...
        // checkExtensionSupport(static_cast<uint32_t>(extensions.size()), extensions.data());
    }
...
//        }
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("/Users/hanbingleng/Documents/Xcode/VulkanTesting/VulkanTesting/shaders/vert.spv");
        auto fragShaderCode = readFile("/Users/hanbingleng/Documents/Xcode/VulkanTesting/VulkanTesting/shaders/frag.spv");
...
//        return deviceProperties.deviceType == VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU && deviceFeatures.geometryShader;
    ...
    void checkExtensionSupport(uint32_t glfwExtCount, const char** glfwExt){
        ...
        for (int i = 0; i < glfwExtCount; i++) {
            ...
            for (const auto& extension : extensions) {
                if (strcmp(glfwExt[i], extension.extensionName) == 0) {
    ...
    bool checkValidationLayerSupport() {
        ...
        std::cout << "validation layers requested:" << std::endl;
        ...
        std::cout << "---layer requirement fulfilled---" << std::endl;
        return true;
    }
